...
namespace ERP
{
    public partial class ConsumerInvoice_Report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    if (Request.QueryString["id"] == "1")
                    {
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/ConsumerInvoiceReport.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_ConsumerInvoiceReports", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_ConsumerInvoiceReports");
            }
            if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/ConsumerInvoiceReport.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_ConsumerInvoiceReports"]);
            ...
            //objReportDoc_Collection.SetParameterValue("AM_AreaID", Request.QueryString["AM_AreaID"].ToString());
            //objReportDoc_Collection.SetParameterValue("PM_ParaId", Request.QueryString["PM_ParaId"].ToString());
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Consumer Invoice Report");
            // }
