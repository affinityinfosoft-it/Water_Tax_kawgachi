...
namespace ERP
{
    public partial class WaterTaxReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    if (Request.QueryString["id"] == "1")
                    {
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/WaterTaxReport.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_WaterTaxReport", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_WaterTaxReport");
            }
            if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/WaterTaxReport.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_WaterTaxReport"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "WaterTax Collection Report");
            // }
