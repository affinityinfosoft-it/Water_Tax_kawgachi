...
namespace ERP
{
    public partial class VoucherEntryReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                        ...
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/VoucherPrint.rpt"));
        ...
        public void printreport()
        {
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["SP_AccountVoucherPrint"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Voucher Entry Report");
            // }
