...
namespace ERP
{
    public partial class Beneficary_Register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    if (Request.QueryString["id"] == "1")
                    {
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/Beneficary Register Report.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_BeneficaryReport", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_BeneficaryReport");
            }
            if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/Beneficary Register Report.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_BeneficaryReport"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Beneficary Register Report");
            // }
