...
namespace ERP
{
    public partial class FerrulReport : System.Web.UI.Page
    {
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_FerrulReport", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_FerrulReport");
            }
           if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/FerrulReport.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_FerrulReport"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
           ...
           if (Request.QueryString["id"] == "1")
            ...
            //if (Request.QueryString["id"] == "1")
            //{
                objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Ferrul Charge Report");
           // }
