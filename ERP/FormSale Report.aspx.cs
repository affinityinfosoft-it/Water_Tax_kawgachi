...
namespace ERP
{
    public partial class FromSale_Report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    if (Request.QueryString["id"] == "1")
                    {
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/FormSale Report.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_FormSaleReport", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_FormSaleReport");
            }
            if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/FormSale Report.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_FormSaleReport"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Form Sale Report");
            // }
