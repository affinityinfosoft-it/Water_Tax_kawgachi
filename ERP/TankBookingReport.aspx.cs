...
namespace ERP
{
    public partial class TankBooking_Report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    if (Request.QueryString["id"] == "1")
                    {
                        objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/TankBookingReport.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("usp_TankBookingReport", ConfigurationManager.ConnectionStrings["ERP_DB_Conn"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "usp_TankBookingReport");
            }
            if (Request.QueryString["id"] == "1")
            {
                objReportDoc_Collection.Load(Server.MapPath("~/Views/Report/RptFiles/TankBookingReport.rpt"));
            ...
            objReportDoc_Collection.SetDataSource(DMSObjSet.Tables["usp_TankBookingReport"]);
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            //if (Request.QueryString["id"] == "1")
            //{
            objReportDoc_Collection.ExportToHttpResponse(formatType, Response, true, "Tank Booking Report");
            // }
